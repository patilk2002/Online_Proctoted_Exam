...
<img src="image/bg.png" style="height:500px;width:100%;" >
</div>
...
<div class="form-group">
  ...
  <div class="col-md-6"> 
    <input  type="submit" class="sub"  value="SIGN UP" style="background:linear-gradient(to right, #da8cff, #9a55ff);padding:5px 10px;margin-left:2%;width:80%;border: none;color:white;" />
  </div>
  <div class="col-md-6"> 
  <a href="#" data-toggle="modal" data-target="#myModal">
  <input  type="button" class="sub" value="LOG IN" style="background:linear-gradient(to right, #da8cff, #9a55ff);padding:5px 10px;margin-left:2%;width:80%;border: none;color:white;"/>
  </a>  
  </div>
