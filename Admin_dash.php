...
echo  '<div class="panel"><div class="table-responsive"> <h4 style="test-align:center">Users</h4></br><table class="table table-striped title1">
...
echo '<div class="panel" style="background-color:#b6b2b2;border-radius: 5px;margin: 40px;padding: 20px;font: 15px "Century Gothic", "Times Roman", sans-serif;"><a title="Back to Archive" href="update.php?q1=2"><b><span class="glyphicon glyphicon-level-up" aria-hidden="true"></span></b></a><h2 style="text-align:center;color:white; margin-top:5px;"><b>'.$subject.'</b></h1>';
...
while($row = mysqli_fetch_array($result)) {
	...
	$eid = $row['eid'];
	echo '<tr><td>'.$c++.'</td><td>'.$title.'</td><td>'.$total.'</td><td>'.$sahi*$total.'</td><td>'.$time.'&nbsp;min</td>
	<td><b><a href="update.php?q=rmquiz&eid='.$eid.'" class="pull-right btn sub1" style="margin:0px;background:#fe7c96;color:white;"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Remove</b></span></a></b></td></tr>';
}
$c=0;
echo '</table></div></div>';
...
$q=mysqli_query($con,"SELECT * FROM history ORDER BY score DESC " )or die('Error223');
echo  '<div class="panel title"><div class="table-responsive">
<table class="table table-striped title1" >
<tr style="color:red">
<td><b>Rank</b></td>
...
if(@$_GET['q']==7) 
{
  ...
  while ($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
      ...
      class='btn btn-primary'>SHOW</button> </td></div></div>
    <?php $no=$no+1; ?>
    </tr>
    
  <?php }

  echo '<input type="hidden" name="path" id="path">
