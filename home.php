        ...
        <div class="navbar-menu-wrapper d-flex align-items-stretch">
          ...
          <ul class="navbar-nav navbar-nav-right">
            ...
            if (!(isset($_SESSION['email']))) {
              ...
              echo '<span class="pull-right top title1" ><span class="log1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;</span><a href="account.php?q=1" style="text-decoration:none;" class="mb-1 text-black">' . $name . '</a></span>';
          ...
          <ul class="nav">
            ...
            <li class="nav-item sidebar-actions">
              <span class="nav-link">
                ...
                <button class="btn btn-block btn-lg btn-gradient-primary mt-4" onclick="javascript:location.href='?q=4#'">+ Add a Feedback</button>
              ...
              <div class="container">
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <?php if (@$_GET['q'] == 1) {
                      ...
                      while ($row = mysqli_fetch_array($result)) {
                        ...
                        <td><b><a href="account.php?q=quiz&step=2&eid=' . $eid . '" class="btn btn-gradient-primary btn-fw" style="margin:0px"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Start
                        </b></span></a></b></td><td style="display:none">' . $tag . '</td></tr>';
                                    } else {
                                      echo '<tr style="color:#1bcfb4"><td>' . $c++ . '</td><td>' . $title . '&nbsp;<span title="This quiz is already solve by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td><td>' . $total . '</td><td>' . $sahi * $total . '</td><td>' . $time . '&nbsp;min</td>
                        <td><b><a href="#"  class="btn btn-gradient-primary btn-fw" style="margin:0px;background:#1bcfb4; width: 115px;" disabled><span class="glyphicon glyphicon-ok" aria-hidden="true" disabled></span>&nbsp;<span class="title1"><b>Submitted</b></span></a></b></td><td style="display:none">' . $tag . '</td></tr>';
                                      }
                        }
                        $c = 0;
                        echo '</table></div></div>';
                  ...
                  if(@$_GET['q']==4) 
                  {
                    ...
                    <div class="form-group">
                      <input id="name" name="name" placeholder="Enter your name" class="form-control input-md" type="text"><br />    
                       <input id="name" name="subject" value="Regarding to Feedback of Website" class="form-control input-md" type="text" readonly>    
                  ...
                  if(@$_GET['q']==5) 
                  {
                    ...
                    echo '<div style="text-align:center "><span style="font-size:24px;text-align:center "><span style="color:green"class="glyphicon glyphicon-ok" aria-hidden="true">Thank you for submiting feedback</span>&nbsp;</span></div>';
                  // echo '<img src="assets/images/done.gif" alt="profile">';
                  }
