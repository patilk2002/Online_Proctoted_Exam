...
<body onload="letsStart()">
        ...
        <nav class="navbar navbar-default title1">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><b>All the Best</b></a>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel" style="margin:5%;margin-top: 10%;">
                        ...
                        <button type="button" onclick="sumbitAns()" class="btn btn-success btn-fw">
                            <span class="glyphicon glyphicon-lock" aria-hidden="true"></span>&nbsp;Submit
                        </button>
                        <button type="button" onclick="submitTestAlert()" class="btn btn-danger btn-fw mr-auto pull-right">
    ...
    <!-- <div class="row footer" style=" position:absolute; bottom:0; width:100%; height:45px; width:1565px; float: center;" >
    ...
    <script>
        ...
        function uploadVid() {
            ...
            $.ajax({
                ...
                $('#myModal').modal('hide');
                var resultUrl = "<?php echo "home.php?q=result&eid=" . $_SESSION['eid']; ?>";
