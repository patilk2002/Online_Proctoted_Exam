...
$folder1 ="captures/".substr($path,0,-9)."/";

$path2=substr($path,0,-9);
$path3 = str_replace('-', '_', $path2);


$folder = str_replace('-', '_', $folder1);

// $folder = "captures/abc@gmail.com63655fbb68a9a2022_11_13/";
...
$audio = "captures/audio/".($path3).".mp3";
