...
include_once 'dbConnection.php';
echo '<span class="pull-right top title1" style="margin-top: 25px" ><span class="log1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hi,</span> <a href="account.php" class="log log1">'.$name.'</a>&nbsp;|&nbsp;<a href="logout.php?q=account.php" class="log"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Signout</button></a></span>';
}?>
...
<nav class="navbar navbar-default title1">
 ...
 -->
        ...
        <li class=""> <a href="showCaptures.php"><span class="glyphicon glyphicon-film" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;Video Captures</a></li>
